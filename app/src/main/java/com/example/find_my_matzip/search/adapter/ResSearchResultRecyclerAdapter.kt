...
import com.example.find_my_matzip.search.ResSearchFragment


class ResSearchResultViewHolder(val binding: RestaurantListBinding) : RecyclerView.ViewHolder(binding.root)

class ResSearchResultRecyclerAdapter(context : ResSearchFragment, var datas: List<RestaurantDto>?) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResSearchResultViewHolder(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val binding = (holder as ResSearchResultViewHolder).binding
