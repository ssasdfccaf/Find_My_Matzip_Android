...
import com.matzip.find_my_matzip.retrofit.AuthInterceptor
import com.matzip.find_my_matzip.retrofit.BoardService
import com.matzip.find_my_matzip.retrofit.CommentService
import com.matzip.find_my_matzip.retrofit.FeelingService
import com.matzip.find_my_matzip.retrofit.RestaurantService
...
class MyApplication : MultiDexApplication() {
    ...
    override fun onCreate() {
        ...
        // 앱 시작할 때 SharedPreferencesManager 싱글톤 객체 생성
