...
import com.matzip.find_my_matzip.databinding.ActivityAddRestaurantBinding
...
class AddRestaurantActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonInsert.setOnClickListener {
            ...
            // 스토리지 접근 도구 ,인스턴스
            val storage = com.matzip.find_my_matzip.MyApplication.Companion.storage
            // 스토리지에 저장할 인스턴스
            ...
            val restaurantService = (applicationContext as com.matzip.find_my_matzip.MyApplication).restaurantService
            ...
            newRestaurant.enqueue(object: Callback<Unit> {
                override fun onResponse(call: Call<Unit>, response: Response<Unit>) {
                    ...
                    if(response.isSuccessful) {
                        ...
                        val intent = Intent(this@AddRestaurantActivity, com.matzip.find_my_matzip.HomeTabActivity::class.java)
        ...
        binding.searchAddress.setOnClickListener{
            //주소 검색 화면으로 이동
            val intent = Intent(this@AddRestaurantActivity, com.matzip.find_my_matzip.SearchAddressActivity::class.java)
