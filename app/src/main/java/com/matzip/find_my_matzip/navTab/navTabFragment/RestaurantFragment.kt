...
import com.matzip.find_my_matzip.databinding.FragmentRestaurantBinding
   ...
   //  lateinit var avgScoreList: Call<List<RestaurantDto>>
    ...
    override fun onCreateView(
        ...
        binding.addRestaurant.setOnClickListener {
            ...
            val intent = Intent(requireContext(), com.matzip.find_my_matzip.AddRestaurantActivity::class.java)
